                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('ime') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="gender" class="col-md-4 col-form-label text-md-end">{{ __('Pol') }}</label>
                            <div class="col-md-6">
                                <select name="gender" id="gender" class="form-control">
                                    <option value="musko" selected>Musko</option>
                        ...
                        <div class="row mb-3">
                            <label for="date_of_birth" class="col-md-4 col-form-label text-md-end">{{ __('Datum rodjenja') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="place_of_birth" class="col-md-4 col-form-label text-md-end">{{ __('Mesto rodjenja') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-end">{{ __('Broj telefona') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="user_type" class="col-md-4 col-form-label text-md-end">{{ __('Tip korisnika') }}</label>
                            ...
                            <div class="col-md-6 row">
                                <div class="d-flex">
                                    ...
                                    <input type="radio" id="korisnik" value='korisnik' name="type" checked>
                                </div>
                                <div class="d-flex">
                                    <div class="w-25">
